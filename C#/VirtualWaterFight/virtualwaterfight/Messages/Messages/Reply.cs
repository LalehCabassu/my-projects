        ...
        new public static Reply Create(ByteList messageBytes)
        {
            ...
            switch (msgType)
            {
                ...
                case 202:
                    ...
                    break;
                case 203:
                    result = PacketizedPlayersListReply.Create(messageBytes);
                    break;
                case 204:
                ...
                case 209:
                    ...
                    break;
                case 210:
                    result = PacketizedFightsListReply.Create(messageBytes);
                    break;
                case 211:
                    result = FightManagerReply.Create(messageBytes);
                    break;
                case 212:
                    result = BalloonManagerReply.Create(messageBytes);
                    break;
                default:
