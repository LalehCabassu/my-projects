...
namespace Messages
{
    public class InprocessFightsListRequest : Request
    {
        #region Data Members and Getters/Setters

        private static Int16 myClassId = 109;
        ...
        /// </summary>
        public InprocessFightsListRequest() : base(PossibleTypes.InprocessFightsList) { }
        ...
        new public static InprocessFightsListRequest Create(ByteList messageBytes)
        {
            InprocessFightsListRequest result = null;
            ...
            {
                result = new InprocessFightsListRequest();
        ...
        override public void Decode(ByteList messageBytes)
        {
            ...
            if (objType != ClassId())
                throw new ApplicationException("Invalid byte array for In-processFightListRequest message");
