...
namespace Messages
{
    public class SpecificFightPlayersListRequest : Request
    {
        #region Data Members and Getters/Setters

        private static Int16 myClassId = 110;
        ...
        /// </summary>
        public SpecificFightPlayersListRequest() : base(PossibleTypes.SpecificFightPlayersList) { }
        ...
        public SpecificFightPlayersListRequest(int fightID) : base(PossibleTypes.SpecificFightPlayersList)
        {
        ...
        new public static SpecificFightPlayersListRequest Create(ByteList messageBytes)
        {
            SpecificFightPlayersListRequest result = null;
            ...
            {
                result = new SpecificFightPlayersListRequest();
        ...
        override public void Decode(ByteList messageBytes)
        {
            ...
            if (objType != ClassId())
                throw new ApplicationException("Invalid byte array for SpecificFightPlayersListRequest message");
