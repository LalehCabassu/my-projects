...
namespace TestVirtualWaterFight.ProtocolsTester
{
    ...
    public class EmpyBalloonTester : ProtocolTester
    {
        ...
        public void TestEmptyBalloonRequestDoer()
        {
            ...
            Assert.AreNotEqual(firstPlayerDoer.MyPlayer.BalloonsList.Last().BalloonID, 0);
        ...
        public void TestEmpyBalloonReplyDoer()
        {
            ...
            Assert.AreNotEqual(myBalloonManager.PlayerList.Last().BalloonsList.Last().BalloonID, 0);
        ...
        public void TestEmpyBalloonDoer()
        {
            ...
            Assert.AreNotEqual(myFightManager.PlayerList.Last().Value.BalloonsList.Last().BalloonID, 0);

            // Water Manager-> Receive and process reply
            Assert.AreEqual(myWaterManager.PlayerList.Last().NumberOfCurrentBalloons(), 1);
            Assert.AreNotEqual(myWaterManager.PlayerList.Last().BalloonsList.Last().BalloonID, 0);
