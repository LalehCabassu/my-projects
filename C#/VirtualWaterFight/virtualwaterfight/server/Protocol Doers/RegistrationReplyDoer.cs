...
namespace Server
{
    public class RegistrationReplyDoer : Doer
    {
        ...
        public void DoProtocol(Envelope message, ManagerConversationList conversationList)
        {
            ...
            message.Message.ConversationId = newReply.ConversationId;
            ManagerConversation newConversation = conversationList.AddNewConversation(message);

            newConversation.SendReply((Message)newReply, (Message)newReply);
            //newConversation.SendReplyToPlayer(newReply);
            //newConversation.SendReplyToManagers((Message)newReply);
        }
        #endregion
