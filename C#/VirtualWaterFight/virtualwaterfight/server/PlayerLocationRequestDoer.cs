...
namespace Server
{
    public class PlayerLocationRequestDoer : Doer
    {
        ...
        {
            PlayerLocationRequestSent = 1,
            PlayerLocationReplyReceived = 2,
            AckNakSent = 3
        }
        ...
        public void SendRequest()
        {
            ...
            foreach (KeyValuePair<IPEndPoint, Player> p in MyFightManager.PlayerList)
            {
                ...
                base.Send((Message)newRequest, p.Key);
                PlayerLocationRequestTimeList[p.Value.PlayerID] = DateTime.Now;
                
                //Update Conversation State
                //conversationState.Add(possibleStates.PlayerLocationRequestSent, (Message)newRequest);
            }
        }
