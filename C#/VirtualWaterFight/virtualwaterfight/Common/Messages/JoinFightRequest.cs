...
namespace Common.Messages
{
    public class JoinFightRequest : InstigateFightRequest
    {
        ...
        public JoinFightRequest(int fightID, Int16 playerID, Location playerLocation, Int16 waterAmount, int balloonID)
            : base(PossibleTypes.JoinFight, playerID, playerLocation, waterAmount, balloonID)
        {
