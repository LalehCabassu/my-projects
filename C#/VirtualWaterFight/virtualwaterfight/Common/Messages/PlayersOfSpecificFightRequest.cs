...
{
    public class PlayersOfSpecificFightRequest : Request
    {
        ...
        /// </summary>
        public PlayersOfSpecificFightRequest() : base(PossibleTypes.PlayersOfSpecificFight) { }
        ...
        public PlayersOfSpecificFightRequest(int fightID) : base(PossibleTypes.PlayersOfSpecificFight)
        {
        ...
        new public static PlayersOfSpecificFightRequest Create(ByteList messageBytes)
        {
            PlayersOfSpecificFightRequest result = null;
            ...
            {
                result = new PlayersOfSpecificFightRequest();
