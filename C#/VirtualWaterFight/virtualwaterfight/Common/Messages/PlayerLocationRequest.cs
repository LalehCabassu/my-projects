...
{
    public class PlayerLocationRequest : Request
    {
        #region Data Members and Getter/Sender

        private static Int16 myClassId = 103;
        ...
        /// </summary>
        public PlayerLocationRequest() : base(PossibleTypes.PlayerLocation) { }
        ...
        new public static PlayerLocationRequest Create(ByteList messageBytes)
        {
            PlayerLocationRequest result = null;
            ...
            {
                result = new PlayerLocationRequest();
        ...
        override public void Decode(ByteList messageBytes)
        {
            ...
            if (objType != ClassId())
                throw new ApplicationException("Invalid byte array for PlayerLocationRequest message");
