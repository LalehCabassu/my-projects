...
{
    public class EmptyBalloonReply : Reply
    {
        ...
        public EmptyBalloonReply(Int16 playerID, int balloonID, PossibleStatus status, string note) :
            base(Reply.PossibleTypes.EmptyBalloon, status, note) 
        {
        ...
        new public static EmptyBalloonReply Create(ByteList messageBytes)
        {
            EmptyBalloonReply result = null;
