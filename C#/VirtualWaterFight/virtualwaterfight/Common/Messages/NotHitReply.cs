...
namespace Common.Messages
{
    public class NotHitReply : Reply
    {
        ...
        public NotHitReply(Int16 throwerID, Location throwerLocation, PossibleStatus status, string note) :
        ...
        public NotHitReply(Int16 throwerID, Location throwerLocation, PossibleTypes type, PossibleStatus status, string note) :
