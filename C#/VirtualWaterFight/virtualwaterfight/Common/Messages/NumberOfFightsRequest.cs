...
{
    public class NumberOfFightsRequest : Request
    {
        #region Data Members and Getters/Setters

        private static Int16 myClassId = 112;
        ...
        /// </summary>
        public NumberOfFightsRequest() : base(PossibleTypes.NumberOfFights) { }
        ...
        public NumberOfFightsRequest(Int16 playerID) : base(PossibleTypes.NumberOfFights)
        {
        ...
        new public static NumberOfFightsRequest Create(ByteList messageBytes)
        {
            NumberOfFightsRequest result = null;
            ...
            {
                result = new NumberOfFightsRequest();
        ...
        override public void Decode(ByteList messageBytes)
        {
            ...
            if (objType != ClassId())
                throw new ApplicationException("Invalid byte array for NumberOfFightRequest message");
