...
{
    public class PlayersListReply : Reply
    {
        ...
        public PlayersListReply(Int16 [] playersList, PossibleStatus status, string note) :
            base(PossibleTypes.PlayersList, status, note) 
        {
