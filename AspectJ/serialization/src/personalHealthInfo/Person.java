...
public class Person {
	...
	public Person(List<Name> names, List<PhoneNumber> phones, List<Address> addresses)
	{
		this.names = names;
	...
	@Protected(getUsername="anthony", getAccessRight=Protected.accessRight.MODIFY)
	...
	public @Override String toString()
	{
		...
		result += this.GetNamesString() + "\n";
		result += this.GetPhoneNumbersString() + "\n";
		result += this.GetAddressesString() + "\n";
	...
	@Protected(getUsername="anthony", getAccessRight=Protected.accessRight.VIEW)
