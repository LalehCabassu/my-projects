...
public class AwsConsoleApp {
    ...
    private static void init() throws Exception {
         ...
         * (/Users/Life/.aws/credentials/rootkey).
         */
        AWSCredentials credentials = null;
        try {
            credentials = new ProfileCredentialsProvider("/Users/Life/.aws/credentials/rootkey", "default").getCredentials();
        } catch (Exception e) {
            throw new AmazonClientException(
                    "Cannot load the credentials from the credential profiles file. " +
                    "Please make sure that your credentials file is at the correct " +
                    "location (/Users/Life/.aws/credentials/rootkey), and is in valid format.",
                    e);
        }
