...
public class EdgeDetector {
	...
	protected static double magnitudeThreshold = 3;
	protected static double thetaThreshold = 180;  	
	protected static Pixels rgbImage;
	protected static Pixels rgbImageOut;
	protected static double rcoeff = 0.2126;
	protected static double gcoeff = 0.7152;
	protected static double bcoeff = 0.0722;
	protected static double defaultDelta = 1.0;
	protected static double defaultTheta = -200;
